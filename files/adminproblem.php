...
if (isset($_SESSION['loggedin']) && $_SESSION['team']['status'] == 'Admin') {
    if (isset($_GET['code'])) {
        ...
        <div id='probadd'>
            ...
            <center><a class='btn btn-primary' onclick="$('#probadd').slideUp(); $('#list').slideDown();">Display List of Problem</a></center><br/>
        </div>
        <?php
        ...
        foreach ($res as $row) {
            echo "<tr><td>$row[pid]</td><td>$row[name]</td><td>$row[score]</td><td>$row[code]</td><td>$row[status]</td><td><a class='btn btn-primary' href='" . SITE_URL . "/adminproblem/$row[code]'><i class='icon-edit icon-white'></i>Edit</a></td></tr>";
        }

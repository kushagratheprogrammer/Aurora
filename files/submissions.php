	...
	if($result['noofpages'] >= $start + 10) 
		...
		$end = $result['noofpages'];
            ...
            <div class ="pagination pagination-centered">
                <ul>        
                    <?php if ($page > 1) { ?>
                        <li><a href="<?php echo SITE_URL . "/submissions/$_GET[code]&page=" . ($page - 1); ?>">Prev</a></li>
                        <?php
                    }
                    for ($i = $start; $i <= $end; $i++) {
                        ?>
                        <li <?php echo ($i == $page) ? ("class='disabled'") : (''); ?>><a href="<?php echo ($i != $page) ? (SITE_URL . "/submissions/$_GET[code]&page=" . $i) : ("#"); ?>"><?php echo $i; ?></a></li>
                        <?php
                    }
                    if ($page < $result['noofpages']) {
                        ?>
                        <li><a href="<?php echo SITE_URL . "/submissions/$_GET[code]&page=" . ($page + 1); ?>">Next</a></li>
                    <?php } ?>
                </ul>
            </div>
            <?php
	...
	if($result['noofpages'] >= $start + 10) 
		...
		$end = $result['noofpages'];
            ...
            <div class ="pagination pagination-centered">
                <ul>        
                    <?php if ($page > 1) { ?>
                        <li><a href="<?php echo SITE_URL . "/submissions&page=" . ($page - 1); ?>">Prev</a></li>
                        <?php
                    }
                    for ($i = $start; $i <= $end; $i++) {
                        ?>
                        <li <?php echo ($i == $page) ? ("class='disabled'") : (''); ?>><a href="<?php echo ($i != $page) ? (SITE_URL . "/submissions&page=" . $i) : ("#"); ?>"><?php echo $i; ?></a></li>
                        <?php
                    }
                    if ($page < $result['noofpages']) {
                        ?>
                        <li><a href="<?php echo SITE_URL . "/submissions&page=" . ($page + 1); ?>">Next</a></li>
                    <?php } ?>
                </ul>
            </div>
            <?php
